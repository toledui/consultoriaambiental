...
$router->get('/favicon.png',          'SeoController@favicon');
...
$router->post('/admin/blog/importar/guardar-plantilla', 'Admin\BlogController@saveImportTemplate');
$router->post('/admin/blog/importar/confirmar',     'Admin\BlogController@confirmImport');
$router->get('/admin/blog/importaciones', 'Admin\BlogController@importHistory');
$router->get('/admin/blog/importaciones/plantilla/{id}/editar', 'Admin\BlogController@editImportTemplate');
$router->post('/admin/blog/importaciones/plantilla/{id}/editar', 'Admin\BlogController@updateImportTemplate');
$router->post('/admin/blog/importaciones/deshacer/{id}', 'Admin\BlogController@undoImportRun');

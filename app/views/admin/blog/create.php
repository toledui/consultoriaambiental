    ...
    <form method="POST" action="<?= BASE_URL ?>/admin/blog/crear" class="p-6">
      ...
      <div id="tab-content" class="tab-panel space-y-6">
        <div>
          ...
          <input class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ca-green focus:border-ca-green outline-none transition" id="title" name="title" type="text" required placeholder="T&iacute;tulo del art&iacute;culo"/>
        </div>

        <div>
          <label class="block text-sm font-medium text-ca-dark-gray mb-1.5" for="slug">Slug (URL)</label>
          <input class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ca-green focus:border-ca-green outline-none transition" id="slug" name="slug" type="text" placeholder="url-amigable-del-articulo (dejar vac&iacute;o para auto-generar)"/>
        ...
        <div>
          ...
          <textarea class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ca-green focus:border-ca-green outline-none transition" id="excerpt" name="excerpt" rows="3" placeholder="Breve descripci&oacute;n del art&iacute;culo"></textarea>
        </div>
      ...
      <div id="tab-seo" class="tab-panel hidden space-y-6">
        ...
        <div class="border border-gray-200 rounded-xl p-4 bg-gray-50">
          ...
          <div id="googlePreview">
            <p class="text-sm text-green-700 font-medium" id="previewUrl"><?= BASE_URL ?>/blog/url-del-articulo</p>
            <p class="text-lg text-blue-700 font-medium hover:underline cursor-pointer" id="previewTitle">T&iacute;tulo del art&iacute;culo</p>

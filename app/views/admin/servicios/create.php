<div class="max-w-5xl mx-auto">
  <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
    ...
    <form method="POST" action="<?= BASE_URL ?>/admin/servicios/crear" enctype="multipart/form-data" class="p-6">
      ...
      <div id="tab-content" class="tab-panel space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ca-green focus:border-ca-green outline-none transition" id="title" name="title" type="text" required placeholder="Nombre del servicio"/>
          </div>
          <div>
            <label class="block text-sm font-medium text-ca-dark-gray mb-1.5" for="slug">Slug (URL)</label>
            <input class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ca-green focus:border-ca-green outline-none transition" id="slug" name="slug" type="text" placeholder="url-amigable-del-servicio"/>
        ...
        <div>
          ...
          <input class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ca-green focus:border-ca-green outline-none transition" id="icon" name="icon" type="text" placeholder="fas fa-leaf" value="fas fa-leaf"/>
        ...
        <div>
          ...
          <textarea class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ca-green focus:border-ca-green outline-none transition" id="description" name="description" rows="3" placeholder="Descripci&oacute;n corta que aparece en las tarjetas"></textarea>
        </div>
        ...
        <div>
          ...
          <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-ca-green transition-colors" id="featuredDropZone">
            <div id="featuredPreview" class="hidden mb-4">
              <img id="featuredPreviewImg" src="" alt="Preview" class="max-h-48 mx-auto rounded-lg shadow-sm"/>
        ...
        <div>
          ...
          <textarea id="content" name="content" class="min-h-[400px]"></textarea>
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            ...
            <input class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ca-green focus:border-ca-green outline-none transition" id="sort_order" name="sort_order" type="number" value="0" min="0"/>
          </div>
      ...
      <div id="tab-seo" class="tab-panel hidden space-y-6">
        ...
        <div>
          ...
          <input class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-ca-green focus:border-ca-green outline-none transition" id="meta_title" name="meta_title" type="text" placeholder="T&iacute;tulo para SEO (si se deja vac&iacute;o, se usar&aacute; el t&iacute;tulo del servicio)" maxlength="70"/>
        ...
        <div class="border border-gray-200 rounded-xl p-4 bg-gray-50">
          ...
          <div id="googlePreview">
            <p class="text-sm text-green-700 font-medium" id="previewUrl"><?= BASE_URL ?>/servicios/url-del-servicio</p>
            <p class="text-lg text-blue-700 font-medium hover:underline cursor-pointer" id="previewTitle">T&iacute;tulo del servicio</p>
            <p class="text-sm text-gray-600" id="previewDesc">Descripci&oacute;n que aparecer&aacute; en los resultados de b&uacute;squeda...</p>
          </div>
        </div>
      </div>
  ...
  "description": "Descripci&oacute;n del servicio"
}"></textarea>

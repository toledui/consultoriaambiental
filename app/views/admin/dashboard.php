...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
  ...
  <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
    <div class="flex items-center justify-between">
      <div>
        <p class="text-sm text-gray-500 font-medium uppercase tracking-wider">Servicios</p>
        <p class="text-4xl font-bold text-ca-navy mt-2"><?= $serviceCount ?></p>
      </div>
      <div class="w-14 h-14 bg-ca-light-green/10 rounded-full flex items-center justify-center text-ca-light-green text-2xl">
        <i class="fas fa-concierge-bell"></i>
      </div>
    </div>
    <a href="<?= BASE_URL ?>/admin/servicios" class="inline-flex items-center text-sm text-ca-green hover:text-ca-navy mt-4 transition-colors">
      Administrar servicios <i class="fas fa-arrow-right ml-1 text-xs"></i>
    </a>
  </div>
  ...
  <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-lg font-bold text-ca-navy mt-2">Nuevo contenido</p>
      </div>
    ...
    <div class="flex gap-2 mt-4">
      <a href="<?= BASE_URL ?>/admin/blog/crear" class="text-xs bg-ca-green hover:bg-green-700 text-white font-medium px-4 py-2 rounded-lg transition-colors">
        + Artículo
      </a>
      <a href="<?= BASE_URL ?>/admin/servicios/crear" class="text-xs bg-ca-navy hover:bg-gray-800 text-white font-medium px-4 py-2 rounded-lg transition-colors">
        + Servicio
      </a>
    </div>
  </div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
  ...
  <p class="text-gray-500">Desde aquí puedes gestionar el contenido del sitio web: artículos del blog y servicios ofrecidos.</p>
</div>
